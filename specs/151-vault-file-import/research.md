...
## Decision: Build this as a new _mechanical_ source in `packages/importer`, reusing the existing `ImportEngine`/`VaultWriter`/review pipeline — not a bespoke OPFS copy module
