...
- **Storage** _(#3354)_: writes schema v2 — entities split into shards plus `entityHashes`, rest of the bundle in `bundle.json` — then deletes any shard no longer populated. A v1 backup becomes v2 on its first full commit.
