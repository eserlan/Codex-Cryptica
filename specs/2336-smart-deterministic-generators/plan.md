...
| --- | ------ | ----------------------------------------------------------------------------------- | ------------------------------------------------------- |
| 1   | #2337  | `smart/` types, predicates, resolver, tests. No generator migrated.                 | Seeded-RNG parity test vs `pickFrom`                    |
| 2   | #2341a | Settlement schema, traits across 13 genres, dependencies, conditional derived pools | Existing settlement tests green, output shape unchanged |
