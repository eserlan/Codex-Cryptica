...
- **Prompt Engineering**: Forcing the AI to always return JSON.
  - _Rejected_: Brittle and might degrade the quality/natural feel of the Oracle's conversational responses.
- **Regex-only**:
  - _Rejected_: Too rigid. A combination of structural analysis (paragraphs) and keyword detection is more robust.
