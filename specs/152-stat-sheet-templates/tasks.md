...
- [ ] T043 Run a full manual pass of quickstart.md end-to-end (all four stories in one continuous session), explicitly timing the presentation switch (SC-001: under 10s) and checking template layouts at both a desktop and a mobile viewport width for overflow/unreadable content (SC-008)
