...
- [x] T001 Install Tiptap bubble menu extension if not present (`pnpm install @tiptap/extension-bubble-menu`)
- [x] T002 ~~Install Tiptap floating menu extension if not present (`pnpm install @tiptap/extension-floating-menu`)~~ (Not required for current scope)
- [x] T003 Install Tiptap Link extension if not present (`pnpm install @tiptap/extension-link`)
