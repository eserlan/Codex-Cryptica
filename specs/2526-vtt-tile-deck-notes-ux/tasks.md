...
- [ ] **1.1 Explicit Armed Tile State in `mapSession`**
...
- [ ] **1.2 Active Thumbnail Ring Highlight in `TileDeckPanel`**
...
- [ ] **1.3 Placement Canvas Banner & Escape Key Cancellation**
...
- [ ] **2.1 Starter Catalog Metadata Verification**
...
- [ ] **2.2 Search Input in `TileDeckPanel`**
...
- [ ] **2.3 Desktop Drag-and-Drop for Tile Thumbnails**
...
- [ ] **3.1 Accessible Segmented Mode Selector**
...
- [ ] **4.1 Editable Note Titles in Inspector**
...
- [ ] **4.2 Markdown Edit/Preview Toggle**
...
- [ ] **4.3 Two-Way Vault Sync & Session Hydration**
...
- [ ] **5.1 Single-Source `parentTokenId` Data Model**
...
- [ ] **5.2 Delta Movement & Deletion Semantics**
...
- [ ] **5.3 Bi-directional Inspector Badges & Manual Linking Actions**
...
- [ ] **6.1 Fixed Top & Sticky Initiative Tracker**
...
- [ ] **6.2 Scrollable Middle Workspace with Height Protection**
...
- [ ] **6.4 End-to-End Acceptance Test Verification**
