...
| Field | Type | Description |
| --- | --- | --- |
| `id` | `string` | Existing theme id such as `fantasy`, `scifi`, or `horror`. |
...
- Unknown world theme ids fall back to the neutral/default world theme without overwriting stored data.
...
No saved world theme -> default world theme -> user selects genre theme -> save per-vault preference
...
- New users with no saved preferences receive neutral app appearance behavior and neutral/default world theme behavior.
