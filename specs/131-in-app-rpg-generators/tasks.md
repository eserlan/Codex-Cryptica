...
- Resolve entity templates in the web app layer and apply them to generated campaign drafts by default while preserving user control to disable or edit template sections.
