...
- [x] T201 Add "View Full Changelog" link to the Marketing Layer in `apps/web/src/routes/(app)/+page.svelte`.
- [x] T202 Add a link to the `/changelog` page in the `SettingsModal.svelte` "About" section.

## Phase 3: SEO & Polish

- [x] T301 Verify meta tags and canonical URL on the `/changelog` page.
- [x] T302 Ensure responsive behavior across mobile and desktop for the new chronology view.
