...
- **Automatic switching on "Open Vault" click**: We considered making the "Open Vault" button automatically detach the current vault.
  - _Decision_: Rejected in favor of an explicit "Close" action to prevent accidental data loss and to provide a clear state for users who simply want to unload data.
