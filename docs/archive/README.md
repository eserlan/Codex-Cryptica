...
This directory contains historical documentation, plans, checklists, and codebase assessments that are no longer active but are preserved for context.

For active guides and the core developer reference, see the parent [docs/](..) folder.

## Archived Documents

- **Cloudflare Migration**:
  - [CLOUDFLARE_MIGRATION_PLAN.md](file:///home/espen/proj/remotecodexarcana/docs/archive/CLOUDFLARE_MIGRATION_PLAN.md): Blueprint for migrating hosting to Cloudflare.
  - [CLOUDFLARE_IMPLEMENTATION_CHECKLIST.md](file:///home/espen/proj/remotecodexarcana/docs/archive/CLOUDFLARE_IMPLEMENTATION_CHECKLIST.md): Action items for Cloudflare transition.
