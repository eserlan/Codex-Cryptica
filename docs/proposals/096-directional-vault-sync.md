...
- **Safety Gate**: If the vault is "Dirty" (has unsaved internal changes), clicking **LOAD** triggers a hard-stop confirmation: _"Warning: You have unsaved internal changes. Loading from the folder will overwrite your current work. Continue?"_
