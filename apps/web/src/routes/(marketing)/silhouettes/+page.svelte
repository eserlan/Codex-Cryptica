...
<SeoHead
  ...
  image="https://assets.codexcryptica.com/screenshots/silhouettes.jpg"
  imageAlt="Codex Cryptica silhouettes gallery showing fantasy character tokens and palette controls"
  imageWidth={1600}
  imageHeight={1000}
  keywords={[
    "rpg silhouettes",
  ...
  >
    ...
    <div class="relative max-w-7xl mx-auto space-y-6 text-center">
      ...
      >
        <span
          aria-hidden="true"
          class="icon-[lucide--sparkles] h-3.5 w-3.5 text-theme-accent"
        ></span>
        ...
        >
          <div class="flex items-center justify-between px-1">
            ...
            >
              <span
                aria-hidden="true"
                class="icon-[lucide--palette] h-3.5 w-3.5 text-theme-accent"
              ></span>
      ...
      >
        ...
        <div class="space-y-1.5 flex-1 min-w-0">
          ...
          >
            <span
              aria-hidden="true"
              class="icon-[lucide--swords] h-3 w-3 text-theme-accent"
            ></span>
            Genre
          </div>
          <div
        ...
        <div class="space-y-1.5 shrink-0">
          ...
          >
            <span
              aria-hidden="true"
              class="icon-[lucide--layout-grid] h-3 w-3 text-theme-accent"
            ></span>
            Category
          </div>
          <div
              ...
              >
                ...
                {#if isSelected}
                  ...
                  >
                    <span
                      aria-hidden="true"
                      class="icon-[lucide--check] h-2.5 w-2.5"
                    ></span>
                  </div>
                {/if}
        ...
        >
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
              <span
                aria-hidden="true"
                class="icon-[lucide--eye] h-4 w-4 text-theme-accent"
              ></span>
              <span
          ...
          <div class="pt-4 border-t border-theme-border/50 space-y-2.5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              >
                <span aria-hidden="true" class="icon-[lucide--download] h-4 w-4"
                ></span>
                Download SVG
              </button>
              ...
              >
                {#if copiedAction === "svg"}
                  <span
                    aria-hidden="true"
                    class="icon-[lucide--check] h-4 w-4 text-theme-accent"
                  ></span>
                  Copied!
                {:else}
                  <span aria-hidden="true" class="icon-[lucide--code] h-4 w-4"
                  ></span>
                  Copy SVG
                {/if}
              </button>
            ...
            >
              {#if copiedAction === "cdn"}
                <span
                  aria-hidden="true"
                  class="icon-[lucide--check] h-3.5 w-3.5 text-theme-accent"
                ></span>
                <span>Copied CDN link to clipboard!</span>
              {:else}
                <span aria-hidden="true" class="icon-[lucide--link] h-3.5 w-3.5"
                ></span>
    ...
    >
      ...
      <div class="relative max-w-3xl space-y-4">
        ...
        >
          <span
            aria-hidden="true"
            class="icon-[lucide--shield-check] h-3.5 w-3.5"
          ></span>
        ...
        <div class="pt-2 flex flex-wrap gap-3 items-center">
          ...
          >
            <span aria-hidden="true" class="icon-[lucide--castle] h-4 w-4"
            ></span>
