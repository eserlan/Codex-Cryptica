<script lang="ts">
  ...
  const screamsheetCard: GeneratorCard = {
    slug: "screamsheet-generator",
    label: "Screamsheet Generator",
    summary:
      "Generate an in-world news sheet — headlines, rumours, classifieds, and propaganda tuned to your genre, with GM-only hooks.",
