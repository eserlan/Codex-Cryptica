<script lang="ts">
  /**
   * Renders the shared generator page for the `quest` slug, with this route's
...
<GeneratorPageContent
  ...
  metaOverrides={{
    ...
    pageTitle:
      "Quest Hook Generator | Free RPG Adventure Hook Tool | Codex Cryptica",
    metaDescription:
      "Generate RPG quest hooks with a hook, complication, key NPC, twist, and reward. Works for D&D, Pathfinder, and any tabletop system. Copy or save into your local campaign vault.",
    eyebrow: "Quest Hook Generator",
    introTitle: "Quest Hook Generator",
    introText:
      "Create a GM-ready quest hook with a location, key NPC, complication, and twist. Works without login, then saves into your local Codex Cryptica campaign vault.",
    relatedLinks,
    faqs,
  }}
/>
