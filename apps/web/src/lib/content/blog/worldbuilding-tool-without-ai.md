---
id: worldbuilding-tool-without-ai
slug: worldbuilding-tool-without-ai
title: "A Worldbuilding Tool Should Still Work Without AI"
description: "If a worldbuilding tool only works when AI is switched on, it is probably not a worldbuilding tool first. Here is what that means for Codex Cryptica."
keywords:
  [
    "worldbuilding tool without AI",
    "RPG campaign manager",
    "local-first worldbuilding",
    "AI-free campaign management",
    "offline RPG tool",
    "worldbuilding software",
    "campaign notes manager",
  ]
