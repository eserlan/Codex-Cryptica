...
describe("the published examples", () => {
  ...
  it("publishes a Space Western ship generated by the Ship Generator", () => {
    const coyote = examples["fv-coyote-space-western-ship"];
    expect(coyote.kind).toBe("ship");
    expect(coyote.genre).toBe("Space Western");
    expect(coyote.generator.href).toBe("/generators/ship-generator");
  });
