...
describe("the published examples", () => {
  ...
  it("publishes a magic-item artifact generated by the Artifact generator", () => {
    const vaelgrasp = examples["vaelgrasp-the-regents-ruin-artifact"];
    expect(vaelgrasp.kind).toBe("item");
    expect(vaelgrasp.generator.href).toBe("/generators/artifact-generator");
  });

  it("publishes a Cosmic Horror creature generated by the Creature Generator", () => {
    const voidSiphon = examples["void-siphon-cosmic-horror-creature"];
    expect(voidSiphon.kind).toBe("creature");
    expect(voidSiphon.genre).toBe("Cosmic Horror");
  ...
  it("publishes a Dark Fantasy / Grimdark faction generated by the new generator", () => {
    const witheredHand = examples["the-withered-hand-grimdark-faction"];
    expect(witheredHand).toBeDefined();
    expect(witheredHand.kind).toBe("faction");
    expect(witheredHand.genre).toBe("Dark Fantasy");
    expect(witheredHand.generator.href).toBe(
