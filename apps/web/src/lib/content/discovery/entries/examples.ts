...
export const exampleEntries: DiscoveryEntryInput[] = [
  ...
  {
    id: "example-bell-beneath-blackglass",
    pageKind: "example",
    canonicalPath: "/examples/the-bell-beneath-blackglass-fantasy-puzzle",
    primaryIntent: "classic fantasy puzzle example",
    intentAliases: [
      "dnd puzzle example",
      "fantasy magical mechanism puzzle example",
      "sample fantasy rpg puzzle",
    ],
    audience: "Classic Fantasy and D&D game masters",
    userJob: "see-an-example",
    uniqueValue:
      "A complete fantasy magical-mechanism puzzle showing multiple independent solutions (realign the rings, redirect the flame, free the bound spirit) and an escalating fail state, rather than a single-answer riddle.",
    parentCluster: "puzzle-design",
    clusters: ["puzzle"],
    relatedIntents: [
      "generator-puzzle",
  ...
  {
    id: "example-null-key-reliquary",
    pageKind: "example",
    canonicalPath: "/examples/the-null-key-reliquary-cyberpunk-puzzle",
    primaryIntent: "cyberpunk puzzle example",
    intentAliases: [
      "cyberpunk mechanical lock puzzle example",
      "corporate vault puzzle example",
      "sample cyberpunk rpg puzzle",
    ],
    audience: "Cyberpunk and corporate-thriller game masters",
    userJob: "see-an-example",
    uniqueValue:
      "A complete cyberpunk mechanical-lock puzzle under a countdown, where every wrong attempt reveals information instead of resetting progress, demonstrating fail-forward design under time pressure.",
    parentCluster: "puzzle-design",
    clusters: ["puzzle"],
    relatedIntents: [
      "generator-puzzle",
