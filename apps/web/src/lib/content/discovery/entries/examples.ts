...
export const exampleEntries: DiscoveryEntryInput[] = [
  ...
  },
  {
    ...
    primaryIntent: "classic fantasy heist example",
    intentAliases: [
      "dnd heist example",
      "fantasy vault heist example",
      "sample fantasy score",
    ],
    audience: "Classic fantasy and D&D game masters",
    userJob: "see-an-example",
    uniqueValue:
  ...
  {
    id: "example-quell-extraction",
    pageKind: "example",
    canonicalPath: "/examples/the-quell-extraction-cyberpunk-heist",
    primaryIntent: "cyberpunk extraction heist example",
    intentAliases: [
      "cyberpunk heist example",
      "corporate extraction example",
      "sample extraction score",
    ],
    audience: "Cyberpunk and corporate-thriller game masters",
    userJob: "see-an-example",
    uniqueValue:
