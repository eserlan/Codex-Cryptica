...
export const forEntries: DiscoveryEntryInput[] = [
  ...
  {
    id: "for-solo-worldbuilding",
    pageKind: "for",
    canonicalPath: "/for/solo-worldbuilding",
    primaryIntent: "solo worldbuilding campaign manager",
    intentAliases: [
      "solo worldbuilding tool",
      "organise a solo worldbuilding project",
      "solo rpg worldbuilding notes",
    ],
    audience: "Solo worldbuilders and solo RPG players",
    userJob: "adopt-workflow",
    uniqueValue:
      "A creator-facing discovery loop where prompts and random results become connected canon, unanswered questions remain visible, and later ideas can be checked against what is already true.",
  ...
  },
  {
    ...
    intentAliases: [
      ...
      "hexcrawl campaign manager",
      "hexcrawl campaign tool",
      "organise a hexcrawl campaign",
    ],
