...
id: family-tree
title: Family Tree
description: View and build a character's parents, partner, children, and siblings as an interactive tree, right from their detail panel.
icon: icon-[lucide--network]
rank: 20
tags: ["family", "characters", "relationships", "genealogy", "tree"]
---

# Family Tree

The Family Tree gives every character a genealogy view built from your existing connections. Open a character's detail panel and click the **Family** tab to see their relatives laid out across generations.

## Reading the tree

The focused character sits in the middle. Around them you'll see:
...
Sharing a parent also links siblings automatically: when a character gets a new parent who already has other children, those children are connected as siblings right away — no extra step needed, and it's never duplicated if the link already exists.
