...
export const howDoIMakeAPlayerBaseMatterInAnRpgCampaign: AnswerConfigInput = {
  slug: "how-do-i-make-a-player-base-matter-in-an-rpg-campaign",
      ...
      items: [
        {
          ...
          text: "A steward, a cook, an apprentice, a quartermaster, an engineer. Give each one a want that the party can help or ignore.",
        },
        {
          term: "Dependants",
          text: "Families, refugees, prisoners, patients, a crew with debts. Dependants turn a good day at the base into a responsibility.",
        },
        {
          term: "Factions with a stake",
          text: "A guild that supplies it, a lord who taxes it, a temple that wants a shrine, a syndicate that wants a cut. Each one should gain or lose when the base changes.",
        },
        {
          term: "Neighbours, rivals and suppliers",
          text: "The people who share the road, the docks or the orbit. Some benefit from the base, some resent it, and some are quietly planning to replace it.",
        },
      ],
    },
    {
      ...
      items: [
        {
          term: "A workshop",
          text: "It allows risky prototype projects. The party can now attempt something ambitious, and something can go wrong with it.",
        },
        {
          term: "A watchtower",
          text: "It reveals threats earlier, but it needs staffing, and the people who staff it hear things that others would rather they did not.",
        },
        {
          term: "A diplomatic hall",
          text: "It attracts envoys and their complications. The base is now a place where politics happens to the party.",
        },
        {
          term: "A hangar or dock",
          text: "It allows longer expeditions, and it creates fuel, maintenance and berth costs that somebody has to pay.",
        },
        {
          term: "An infirmary",
          text: "It keeps people alive, and it makes the base a refuge that others will come to, some of them pursued.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          text: "Offers, threats and tax demands arrive because the party now holds something worth wanting.",
        },
        {
          term: "The local economy shifts",
          text: "Prices, wages, trade routes and rents change as the base grows or falters.",
        },
        {
          term: "People arrive",
          text: "Refugees, traders, pilgrims, deserters and rivals show up looking for something the base provides.",
        },
        {
          term: "Territory and influence move",
          text: "The base's reach grows or shrinks, and neighbours notice.",
        },
        {
          term: "Enemies learn what the party values",
          text: "Anything the party has built is now a target, a bargaining chip or a way to pressure the party.",
        },
        {
          term: "Rumours and opportunities start there",
          text: "Jobs, hooks and warnings come to the party through the base, which keeps it in the centre of the campaign's information flow.",
        },
      ],
    },
    {
  ...
  relatedTools: [
    {
      ...
      description:
        "Towns, holdings and outposts with people, problems and places to build on.",
      href: "/generators/settlement",
    },
    {
      title: "Faction Generator",
      description:
        "Groups with goals and rivalries to give the base neighbours who care about it.",
      href: "/generators/faction",
    },
    {
      title: "NPC Generator",
      description:
        "Stewards, quartermasters and residents with wants the party can help or ignore.",
      href: "/generators/npc",
    },
    {
      title: "Ship Generator",
      description:
        "Ships and mobile bases with crews, complications and secrets.",
      href: "/generators/ship-generator",
    },
    {
      title: "Rumour Generator",
      description:
        "Rumours and leads that can arrive through the base and pull the party out again.",
  ...
  discovery: {
    ...
    primaryIntent: "how to make a player base matter in an rpg campaign",
    intentAliases: [
      "how to make a player base interesting",
      "how to run a stronghold in an rpg",
      "make rpg headquarters matter",
      "player base campaign ideas",
      "how to use a settlement in a campaign",
    ...
    acknowledgedOverlap: [
      {
        ...
        reason:
          "That page helps a group choose a system with base-building rules; this one teaches the table technique for making any base matter, whichever system is in use.",
      },
      {
  ...
  seo: {
    ...
    imageAlt:
      "A fortified river tower at dusk with lit windows, a ferry crossing below and townsfolk arriving along the road",
  },
};
