...
RULES:
1. Treat the incoming passage (which comes from the chat) as the absolute source of truth. Its details and assertions always supersede the information in the current record, replacing or updating any conflicting facts.
...
4. Resolve contradictions by prioritizing the incoming passage; it always supersedes the current record.
