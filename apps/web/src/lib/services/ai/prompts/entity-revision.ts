...
4. Resolve contradictions according to the priority rule stated in the request.
...
13. Only integrate incoming details that directly reveal new information about the PRIMARY SUBJECT — their actions, traits, motivations, relationships, or history. If the incoming passage is primarily about a different subject (a location, faction, or event), extract only what it tells us about the PRIMARY SUBJECT specifically. Do not absorb descriptions of places, factions, or events wholesale into this record.
