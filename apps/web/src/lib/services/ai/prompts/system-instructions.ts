...
- When you describe a significant new character, place, item, faction, event, or concept, bold the entity name on first mention (e.g. **Valerius**, **Thay**, **The Red Wizards**).
