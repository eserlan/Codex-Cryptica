...
export const VERSION =
  import.meta.env.VITE_APP_VERSION ?? versionFromBuild ?? "0.26.4";
  ...
  "@graph": [
    {
      ...
      keywords:
        "local-first RPG campaign manager, private worldbuilding tool, offline campaign notes, Markdown RPG vault, spatial lore graph, AI GM assistant",
