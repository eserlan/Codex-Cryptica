...
export const BUILT_IN_STAT_SHEET_TEMPLATES: StatSheetTemplate[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "loc_chest", label: "Chest (AP/HP)", type: "text" },
      { id: "loc_abdomen", label: "Abdomen (AP/HP)", type: "text" },
      { id: "loc_rarm", label: "Right Arm / Foreleg (AP/HP)", type: "text" },
      { id: "loc_larm", label: "Left Arm / Foreleg (AP/HP)", type: "text" },
      { id: "loc_rleg", label: "Right Leg / Hindleg (AP/HP)", type: "text" },
      { id: "loc_lleg", label: "Left Leg / Hindleg (AP/HP)", type: "text" },
