...
function isGraphRelevantEntityChange(
...
function connectionsEqual(a: any[] = [], b: any[] = []): boolean {
...
function temporalEqual(a: any, b: any): boolean {
  if (a === b) return true;
  if (!a || !b) return !a && !b;
  return (
    a.year === b.year &&
...
function coordinatesEqual(a: any, b: any): boolean {
