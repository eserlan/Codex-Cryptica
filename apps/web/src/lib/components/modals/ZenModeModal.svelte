...
{#if uiStore.showZenMode && entity}
    ...
    >
        ...
        >
            ...
            <!-- Header -->
            <header
                class="px-6 py-4 border-b border-green-900/20 bg-[#0a0a0a] flex justify-between items-start shrink-0"
            >
                <div class="flex-1 mr-8">
                    <div class="flex items-center gap-3 mb-1">
                        ...
                        ></span>
                        <span
                            class="text-[10px] font-bold tracking-widest text-green-600 uppercase"
                            >{entity.type}</span
                        >
                    </div>
                    {#if isEditing}
                    ...
                    {:else}
                        <h1
                            ...
                            class="text-3xl md:text-4xl font-serif font-bold text-gray-100 tracking-wide"
                        >
                            {entity.title}
                        </h1>
                    {/if}
                ...
                <div class="flex items-center gap-3">
                    {#if !isEditing}
                        <button
                            onclick={handleCopy}
                            class="px-3 py-1.5 border border-green-900/50 text-green-600 hover:text-green-400 hover:border-green-500 text-xs font-bold rounded tracking-widest transition flex items-center gap-2"
                            title="Copy Content"
                        >
                            {#if isCopied}
                                <span
                                    class="icon-[lucide--check] w-4 h-4 text-green-400"
                                ></span>
                            {:else}
            ...
            <!-- Navigation Tabs -->
            <div
                class="flex gap-8 px-8 border-b border-green-900/20 bg-[#0c0c0c] shrink-0"
            >
                <button
            ...
            <div class="flex-1 overflow-hidden flex flex-col md:flex-row">
                {#if activeTab === "overview"}
                    ...
                    >
                        ...
                        <div class="mb-6">
                            ...
                            {:else}
                                <div
                                    class="w-full aspect-square rounded-lg border border-dashed border-green-900/30 flex flex-col items-center justify-center gap-2 text-green-900/50 bg-green-900/5"
                                >
                                    <span
                        ...
                        <div class="space-y-4">
                            <h3
                                class="text-xs font-bold text-green-900 uppercase tracking-widest border-b border-green-900/20 pb-2"
                            >
                                Connections
                            </h3>
                                    ...
                                    {#each allConnections as conn}
                                        ...
                                        >
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div
                                                    class="text-[11px] text-green-700 uppercase font-mono"
                                                >
                                                    {conn.label}
                                                </div>
                                                <div
                                                    class="text-sm font-bold text-gray-400 group-hover:text-green-400 truncate transition"
                                                >
                                                    {conn.title}
                                                </div>
                                            </div>
                                            <span
                                                class="icon-[lucide--chevron-right] w-4 h-4 text-green-900 group-hover:text-green-500 opacity-0 group-hover:opacity-100 transition"
                                            ></span>
                                        </button>
                                    {/each}
                                </div>
                    ...
                    >
                        <div class="max-w-3xl mx-auto space-y-12">
                            ...
                            {#if isEditing}
                                <div
                                    class="bg-black/30 p-4 rounded border border-green-900/20"
                                >
                                    <h3
                                        class="text-xs font-bold text-green-700 uppercase tracking-widest mb-4"
                                    >
                            ...
                            {:else if entity.start_date || entity.end_date}
                                <div
                                    class="flex flex-wrap gap-8 p-4 bg-green-900/5 border border-green-900/10 rounded"
                                >
                                    {#if entity.start_date}
                                        <div class="flex flex-col">
                                            <span
                                                class="text-[10px] text-green-800 uppercase font-bold tracking-widest mb-1"
                                                >{getTemporalLabel(
                                                    entity.type,
                                                    "start",
                                                )}</span
                                            >
                                            <span
                                                class="text-lg font-mono text-green-400"
                                                >{formatDate(
                                                    entity.start_date,
                                                )}</span
                                            >
                ...
                {:else if activeTab === "inventory"}
                    <div
                        class="flex-1 p-8 flex items-center justify-center text-gray-600 font-mono text-sm italic"
                    >
