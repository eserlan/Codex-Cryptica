...
export function createDrawingLogic(
  ...
  function finishDrawing(event: PointerEvent, cancelled = false) {
    ...
    cancelActiveDrawing();
    if (!cancelled) addDrawing(completedDrawing);
  }
  ...
  return {
    get isDrawingMode() { return isDrawingMode; },
    get isErasingMode() { return isErasingMode; },
    get drawingColor() { return drawingColor; },
    get drawingWidth() { return drawingWidth; },
    get activeDrawing() { return activeDrawing; },
    get activeDrawingPointerId() { return activeDrawingPointerId; },
