...
{#if proposerStore.activeHistory.length > 0}
  <div class="space-y-3 mt-4">
    {#each proposerStore.activeHistory as proposal (proposal.id)}
      <div class="bg-theme-bg/20 border border-theme-border/30 rounded-lg p-3 flex justify-between items-center opacity-70 hover:opacity-100 transition-opacity">
        <div class="text-sm">
          <span class="text-theme-muted line-through decoration-theme-secondary/50">
