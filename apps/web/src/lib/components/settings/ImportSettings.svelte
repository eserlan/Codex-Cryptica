      ...
      <div class="flex flex-col items-center gap-6 py-8">
        <div class="relative">
          ...
          <div class="absolute inset-0 flex items-center justify-center">
            <span class="icon-[lucide--zap] text-theme-primary animate-pulse w-4 h-4" aria-hidden="true"></span>
          </div>
        </div>
      ...
      {#if controller.ccSession}
        ...
        >
          <div class="flex items-start gap-2">
            <span class="icon-[lucide--database-zap] mt-0.5 h-4 w-4 shrink-0 text-theme-primary" aria-hidden="true"></span>
            <div class="min-w-0">
              <p
