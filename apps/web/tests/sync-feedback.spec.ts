...
test.describe("Sync Visual Feedback", () => {
  ...
  test("should show flash effect when sync button is clicked", async ({
    page,
  }) => {
    // Open Settings Modal
  ...
  test("should display SYNCING state when sync is triggered", async ({
    page,
  }) => {
