...
7. Concise & Punchy Table-Ready Prose: Keep descriptions sharp, vivid, and economical (1-2 sentences or compact bullet points per section). Avoid rambling essays or repetitive filler so the draft is immediately readable and gameable.
...
- Output is concise, tight, and punchy without unnecessary fluff.

You must return a valid JSON object matching this schema:
{
  "title": "Evocative Artifact Name",
  "content": "1-2 vivid markdown paragraphs describing physical appearance, materials, ancient craftsmanship, tactile texture, sensory aura, and visual details when inspected.",
  "lore": "Markdown formatted GM reference with the following exact headings:\\n\\n### Quick Reference\\n- **Item Form**: ${resolved.form}\\n- **Origin Era**: ${resolved.originEra}\\n- **Power Tier**: ${resolved.powerTier}\\n- **Current Status**: ${resolved.currentStatus}\\n- **Curse / Cost**: ${resolved.curseCost}\\n- **Setting / Theme**: ${resolved.genre}\\n\\n### ${powersHeading}\\n- **Dormant Powers**: 1 concise bullet with baseline subtle effects and passive tells.\\n- **Awakened Powers**: 1 concise bullet with activated major abilities and tactical effects.\\n- **Ascendant / Zenith Powers**: 1 concise bullet with cataclysmic or campaign-scale powers.\\n\\n### Attunement & Awakening Requirements\\n1-2 sharp sentences on what a mortal, hero, or engineer must do, sacrifice, or understand.\\n\\n### Cost, Curse, or Taboo\\n1-2 sharp sentences on the consequential price of wielding or keeping the artifact.\\n\\n### Known History & Previous Keepers\\n1-2 brief bullets on creators, historical milestones, and previous wielders.\\n\\n### Interested Factions & Pursuers\\n2 concise bullets naming interested factions, rivals, or rulers and their motives.\\n\\n### Rumours & Conflicting Legends\\n2 brief bullets of folk beliefs, false assumptions, or exaggerated tales.\\n\\n### Adventure Hooks\\n2-3 concise 1-sentence scenario hooks for finding, stealing, protecting, or neutralizing the artifact.\\n\\n### Destruction or Sealing Conditions\\n1 concise description of the specific ritual, environment, or feat required to destroy or seal it.",
