...
export const lancerTables: DungeonGenreTables = {
  ...
  factionObstacles: [
    "a reactor margin that will not sustain another cycle",
    "a rival retrieval team already three levels down",
    "a lockout the vault intelligence will not release",
    "their own internal discord and mistrust",
    "a hull breach they lack the plate to seal",
    "a Union inspection already logged and inbound",
    "a debt to the cartel that fronted their claim",
    "a salvage window that closes when the permit lapses",
  ],
  loreFinds: [
    "A maintenance log with one frame checked out and never returned.",
    "A withdrawal order timestamped hours before its stated cause.",
    "A pilot's personal recording, addressed to nobody in particular.",
    "A requisition for printer feedstock in a grade never licensed here.",
    "A casualty list with more names than the garrison ever mustered.",
  ],
  roomEncounters: [
    "A bay drone still enforcing an obsolete IFF challenge.",
    "A frame's severed arm actuator, still powered and still gripping.",
    "A cargo loader frame walking a delivery route with nothing to deliver.",
    "A maintenance construct that treats intruders as loose debris.",
    "A quarantine drone insisting on a decontamination cycle nobody consents to.",
  ],
  secrets: [
