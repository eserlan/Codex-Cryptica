...
export const modernConspiracyTables: DungeonGenreTables = {
  ...
  factionObstacles: [
    "a cover story that will not survive scrutiny",
    "a rival agency working the same site",
    "a compartmentalisation order that starves them of context",
    "their own internal discord and mistrust",
    "a contamination exposure none of them have reported",
    "an oversight committee already asking questions",
    "a debt to the contractor who arranged their clearance",
    "a sanitisation deadline they cannot extend",
  ],
  loreFinds: [
    "A sign-in sheet with a visitor who has no corresponding badge record.",
    "A memo instructing staff to route findings around the official channel.",
    "A photograph with one figure crudely airbrushed out.",
    "A requisition for equipment that does not appear in any inventory.",
    "A transcript with nine minutes of silence marked as inaudible.",
  ],
  roomEncounters: [
    "A site physician still conducting scheduled examinations on nobody.",
    "A caretaker who has not been relieved in a very long time.",
    "A containment subject that was never fully removed.",
    "A janitor with full clearance who should have retired decades ago.",
    "A guard dog left behind with the doors, and still fed by someone.",
  ],
  secrets: [
