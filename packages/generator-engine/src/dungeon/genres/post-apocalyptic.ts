...
export const postApocalypticTables: DungeonGenreTables = {
  ...
  factionObstacles: [
    "a ration store that will not last the winter",
    "a rival band holding the only clean well",
    "a sickness they have no medicine for",
    "their own internal discord and mistrust",
    "radiation creeping in through a breach they cannot seal",
    "a warlord's tribute falling due",
    "a debt to the settlement that took them in",
    "a storm season that will cut them off entirely",
  ],
  loreFinds: [
    "A shelter logbook whose entries stop mid-sentence.",
    "A pre-collapse newspaper dated three days after the official end.",
    "A child's drawing of the surface, made by someone who never saw it.",
    "A duty roster with every name crossed out but one.",
    "A sealed evacuation order that was never read aloud.",
  ],
  roomEncounters: [
    "A pack of rad-scarred dogs denned in a supply alcove.",
    "A lone scavenger who will shoot first and negotiate afterward.",
    "A nest of bloat-flies risen from a burst containment drum.",
    "An automated turret with one working servo and plenty of ammunition.",
    "A mutated crawler that has learned to mimic a human voice.",
  ],
  secrets: [
