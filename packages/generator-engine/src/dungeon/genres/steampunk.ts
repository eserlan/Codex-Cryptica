...
export const steampunkTables: DungeonGenreTables = {
  ...
  factionObstacles: [
    "a coal allocation that runs out this quarter",
    "a rival concern with a competing patent claim",
    "a guild rule they cannot be seen to break",
    "their own internal discord and mistrust",
    "a boiler certificate that expired years ago",
    "the inspectorate scheduling an unannounced visit",
    "a debt to the investors who financed the works",
    "a pressure test due before the month is out",
  ],
  loreFinds: [
    "A maintenance log signed by an engineer who died before the entries were made.",
    "A patent application in two hands, the second name scratched out.",
    "A pressure chart showing a spike nobody reported.",
    "A pay ledger listing workers by number rather than name.",
    "A sealed instruction envelope marked to be opened only on shutdown.",
  ],
  roomEncounters: [
    "A malfunctioning automaton repeating one step of an assembly cycle.",
    "A stoker automaton shovelling into a firebox that went cold years ago.",
    "A colony of soot-bloated rats grown bold in the warm dark.",
    "A guild inspector's clockwork proxy demanding credentials nobody carries.",
    "A brass watchdog that wakes on vibration and does not tire.",
  ],
  secrets: [
