...
export const pirateTables: DungeonGenreTables = {
  ...
  factionObstacles: [
    "a water cask supply already gone brackish",
    "a rival crew who know the same channel",
    "articles of agreement none of them can breach",
    "their own internal discord and mistrust",
    "a fever moving through the lower berths",
    "a naval patrol working the coast this season",
    "a debt to the merchant who fenced their last haul",
    "a tide that only serves them once a fortnight",
  ],
  loreFinds: [
    "A ship's articles signed by more hands than ever came ashore.",
    "A logbook whose last position fix places the vessel inland.",
    "A share-out tally with one portion permanently unclaimed.",
    "A letter of marque with the issuing seal carefully scraped off.",
    "A chart annotated in two hands, the second correcting the first.",
  ],
  roomEncounters: [
    "A colony of grasping deep-crabs in a flooded gallery.",
    "A marooned crewman who has been down here far too long.",
    "A moray the size of a man in a submerged passage.",
    "A one-eyed cook still guarding the galley stores with a cleaver.",
    "A powder-monkey's ghost story that turns out to be walking around.",
  ],
  secrets: [
