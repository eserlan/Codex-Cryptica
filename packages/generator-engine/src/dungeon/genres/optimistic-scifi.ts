...
export const optimisticSciFiTables: DungeonGenreTables = {
  ...
  factionObstacles: [
    "a survey window that closes with the season",
    "a partner expedition with an incompatible mandate",
    "a protocol requiring consent they cannot yet obtain",
    "their own good-faith disagreement about method",
    "an atmosphere tolerance that limits time inside",
    "a caretaker system that will not proceed without clarification",
    "an obligation to the council that chartered them",
    "a dormancy cycle they must not interrupt",
  ],
  loreFinds: [
    "An orientation plaque written for a reader with a different number of eyes.",
    "A research log continued in three hands across two species.",
    "A handover note apologising for what the next team will have to redo.",
    "A star chart annotated with courtesy warnings rather than claims.",
    "A sealed letter addressed simply to whoever arrives.",
  ],
  roomEncounters: [
    "A curious garden creature entirely unafraid of visitors.",
    "A caretaker drone politely but firmly blocking a restricted door.",
    "A grazing herd-analogue that has decided the party is worth following.",
    "A survey drone from a rival expedition, cataloguing the same room.",
    "A dormant crew member, roused early and gently confused about the date.",
  ],
  secrets: [
