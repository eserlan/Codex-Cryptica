...
export const spaceOperaResistanceTables: DungeonGenreTables = {
  ...
  factionObstacles: [
    "a supply line the occupation cut months ago",
    "a rival cell claiming the same territory",
    "a compartment rule that keeps them from coordinating",
    "their own internal discord and mistrust",
    "an informant they know is among them",
    "an orbital sweep pattern tightening each week",
    "a debt to the smugglers who move their people",
    "an amnesty deadline that is splitting the cadre",
  ],
  loreFinds: [
    "A cadre roster with two-thirds of the names struck through.",
    "A dead-drop schedule updated more recently than the base was abandoned.",
    "A cipher pad with the first several pages torn out.",
    "An amnesty leaflet, folded and refolded many times.",
    "A supply manifest showing a diversion nobody in the cell authorised.",
  ],
  roomEncounters: [
    "An occupation scout drone sweeping on a slow patrol arc.",
    "A sentry left on watch who has not been told the cell disbanded.",
    "A refugee family hiding and prepared to defend themselves.",
    "A courier who bolts at first contact and will raise an alarm if she escapes.",
    "A scuttle charge on a dead-man circuit with a failing indicator.",
  ],
  secrets: [
