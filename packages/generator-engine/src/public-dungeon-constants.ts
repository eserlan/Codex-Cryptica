...
export const dungeonConfig = {
  ...
  /**
   * Which purposes make sense for each genre — a fantasy delve shouldn't offer
   * "Data Vault & Archive", and a cyberpunk one shouldn't lead with "Temple & Shrine".
   */
  purposesByGenre: {
    Fantasy: [
      "Temple & Shrine",
  ...
  /** Which current states make sense for each genre. */
...
/** Fallback for custom purposes. Keyed by genre. See ORIGINAL_USE_BY_PURPOSE. */
...
/** Fallback for custom current states. Keyed by genre. See CONDITION_BY_STATE. */
