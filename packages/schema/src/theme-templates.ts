...
export const THEMES = {
  ...
  scifi: {
    ...
    tokens: {
      ...
      panelFill: "rgba(12, 12, 12, 0.88)",
      panelMuted: "rgba(5, 5, 5, 0.88)",
  ...
  pirate: {
    ...
    name: "Charted Waters",
    description:
      "Weathered charts, storm-blue water, dark timber, and restrained brass for mature nautical adventures.",
    tokens: {
      primary: "#164e63",
      secondary: "#475569",
      background: "#f3ead8",
      surface: "#e8dcc4",
      text: "#1f2933",
      border: "rgba(92, 72, 48, 0.48)",
      accent: "#a9782f",
      fontHeader: "'Alegreya', serif",
      fontBody: "'Inter', sans-serif",
      texture: "nautical_chart.svg",
      ...
      iconActive: "#164e63",
      focus: "#a9782f",
      panelFill: "color-mix(in srgb, #e8dcc4, #f3ead8 48%)",
      panelMuted: "color-mix(in srgb, #e8dcc4, #f3ead8 68%)",
      selectedBg: "color-mix(in srgb, #a9782f, #f3ead8 86%)",
      selectedBorder: "color-mix(in srgb, #a9782f, #f3ead8 38%)",
      focusBg: "color-mix(in srgb, #a9782f, #f3ead8 76%)",
      focusBorder: "#a9782f",
      actionBg: "#164e63",
      actionHover: "#0f3c4c",
      actionText: "#f8f1e4",
...
export const PIRATE_DARK: StylingTemplate = {
  id: "pirate_dark",
  name: "Lantern Harbour",
  description:
    "Storm-blue water, tarred timber, lantern brass, and sea-mist text for dark nautical adventures.",
  tokens: {
    primary: "#67a6b8",
    secondary: "#9aaab0",
    background: "#101c24",
    surface: "#1a2a32",
    text: "#e7eee9",
    border: "rgba(119, 153, 158, 0.46)",
    accent: "#d0a456",
    fontHeader: "'Alegreya', serif",
    fontBody: "'Inter', sans-serif",
    texture: "harbour_night.svg",
    ...
    panelFill: "#21343c",
    panelMuted: "#17272f",
    selectedBg: "color-mix(in srgb, #67a6b8, #101c24 78%)",
    selectedBorder: "#67a6b8",
    focusBg: "color-mix(in srgb, #d0a456, #101c24 78%)",
    focusBorder: "#d0a456",
    actionBg: "#2d7183",
    actionHover: "#3c8b9b",
    actionText: "#f5f3e9",
...
export const SCIFI_LIGHT: StylingTemplate = {
  ...
  description:
    "Traditional sci-fi interface — crisp starship telemetry aesthetic with steel-blue base, navy authority, and amber tactical accents.",
  tokens: {
    primary: "#1e40af",
    secondary: "#0f766e",
    background: "#f0f4f8",
    ...
    panelMuted: "rgba(240, 245, 251, 0.98)",
    fontHeader: "'Orbitron', sans-serif",
    fontBody: "'Inter', sans-serif",
  },
  graph: {
...
export const HORROR_LIGHT: StylingTemplate = {
  ...
  description:
    "Aristocratic dossier styling in cold aged ivory, near-black charcoal, and dried blood.",
  tokens: {
    primary: "#801414",
    secondary: "#4a4543",
    background: "#e4dfd5",
    ...
    iconActive: "#801414",
    focus: "#801414",
    panelFill: "color-mix(in srgb, #eee9df, #e4dfd5 40%)",
    panelMuted: "color-mix(in srgb, #eee9df, #e4dfd5 70%)",
    selectedBg: "color-mix(in srgb, #801414, #e4dfd5 90%)",
    selectedBorder: "color-mix(in srgb, #801414, #e4dfd5 45%)",
    focusBg: "color-mix(in srgb, #801414, #e4dfd5 80%)",
    focusBorder: "#801414",
    actionBg: "#801414",
    actionHover: "#630f0f",
    actionText: "#f4f0e8",
...
export const FALLOUT_LIGHT: StylingTemplate = {
  ...
  tokens: {
    ...
    surface: "#ffffff",
    text: "#334155",
    border: "rgba(30, 64, 175, 0.55)",
    accent: "#d97706",
    texture: "vault_blueprint.svg",
    panelFill: "rgba(255, 255, 255, 1.0)",
    panelMuted: "rgba(255, 255, 255, 1.0)",
    fontHeader: "'Share Tech Mono', monospace",
    fontBody: "'Share Tech Mono', monospace",
  },
  graph: {
