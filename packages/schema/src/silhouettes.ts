...
export const SILHOUETTES: SilhouetteDefinition[] = [
  ...
  {
    id: "fantasy-creature-griffin",
    name: "Sylvan Griffin / Gryphon",
    category: "creature",
    genres: ["fantasy"],
    archetype: "beast",
    tags: [
    ...
    r2Path: "silhouettes/creature/fantasy/griffin.svg",
  },
  {
    id: "fantasy-creature-hydra",
    name: "Multi-Headed Swamp Hydra",
    category: "creature",
    genres: ["fantasy", "gothic"],
    archetype: "beast",
    tags: [
    ...
    r2Path: "silhouettes/creature/fantasy/hydra.svg",
  },
  {
    id: "fantasy-creature-stone-colossus",
    name: "Stone Colossus / Megalith Titan",
    category: "creature",
    genres: ["fantasy"],
    archetype: "construct",
    tags: [
    ...
    r2Path: "silhouettes/creature/fantasy/stone-colossus.svg",
  },
  ...
  {
    id: "fantasy-faction-martial-order",
    name: "Martial Knight Order",
    category: "faction",
    genres: ["fantasy", "gothic"],
    archetype: "insignia",
    tags: [
    ...
    r2Path: "silhouettes/faction/fantasy/martial-order.svg",
  },
  {
    id: "fantasy-faction-arcane-circle",
    name: "Arcane Wizard Circle",
    category: "faction",
    genres: ["fantasy"],
    archetype: "insignia",
    tags: [
    ...
    r2Path: "silhouettes/faction/fantasy/arcane-circle.svg",
  },
  {
    id: "fantasy-faction-thieves-guild",
    ...
    r2Path: "silhouettes/faction/fantasy/thieves-guild.svg",
  },
  {
    id: "fantasy-faction-merchant-league",
    name: "Merchant Trade League",
    category: "faction",
    genres: ["fantasy"],
    archetype: "insignia",
    tags: [
    ...
    r2Path: "silhouettes/faction/fantasy/merchant-league.svg",
  },
  {
    id: "fantasy-faction-holy-order",
    name: "Sacred Holy Order / Inquisition",
    category: "faction",
    genres: ["fantasy", "gothic"],
    archetype: "insignia",
    tags: [
    ...
    r2Path: "silhouettes/faction/fantasy/holy-order.svg",
  },
  ...
  // ==========================================
  {
    id: "fantasy-event-battle-war",
    name: "Great Battle / Warfare",
    category: "event",
    genres: ["fantasy", "gothic"],
    archetype: "warrior",
    tags: [
    ...
    r2Path: "silhouettes/event/fantasy/battle-war.svg",
  },
  {
    id: "fantasy-event-arcane-ritual",
    name: "Arcane Ritual / Conjunction",
    category: "event",
    genres: ["fantasy", "gothic", "cosmic-horror"],
    archetype: "caster",
    tags: [
    ...
    r2Path: "silhouettes/event/fantasy/arcane-ritual.svg",
  },
  {
    id: "fantasy-event-coronation-treaty",
    name: "Royal Coronation / Summit",
    category: "event",
    genres: ["fantasy", "gothic"],
    archetype: "noble",
    tags: [
    ...
    r2Path: "silhouettes/event/fantasy/coronation-treaty.svg",
  },
  {
    id: "fantasy-event-cataclysm-ruin",
    name: "Cataclysm / Falling Ruin",
    category: "event",
    genres: ["fantasy", "gothic", "cosmic-horror"],
    archetype: "structure",
    tags: [
    ...
    r2Path: "silhouettes/event/fantasy/cataclysm-ruin.svg",
  },
  {
    id: "fantasy-event-festival-tournament",
    name: "Grand Festival / Tournament",
    category: "event",
    genres: ["fantasy"],
    archetype: "generic",
    tags: [
    ...
    r2Path: "silhouettes/event/fantasy/festival-tournament.svg",
  },
  ...
  {
    id: "scifi-creature-xenomorph",
    name: "Xeno Stalker / Alien Predator",
    category: "creature",
    genres: ["scifi", "cosmic-horror"],
    archetype: "horror",
    gender: "neutral",
    ...
    r2Path: "silhouettes/creature/scifi/xenomorph-predator.svg",
  },
  {
    id: "scifi-creature-swarm",
    name: "Hive Drone / Swarm Insectoid",
    category: "creature",
    genres: ["scifi"],
    archetype: "beast",
    gender: "neutral",
    ...
    r2Path: "silhouettes/creature/scifi/swarm-insectoid.svg",
  },
  {
    id: "scifi-construct-drone",
    name: "Security Drone / Sentry Bot",
    category: "creature",
    genres: ["scifi", "cyberpunk"],
    archetype: "construct",
    gender: "neutral",
    ...
    r2Path: "silhouettes/creature/scifi/security-drone.svg",
  },
  {
    id: "scifi-item-energy-blade",
  ...
  },
  {
    ...
    r2Path: "silhouettes/location/scifi/jump-gate.svg",
  },
  {
    id: "scifi-navigator-astrogator",
    name: "Starship Astrogator / Surveyor",
    category: "character",
    genres: ["scifi"],
    archetype: "scientist",
    gender: "neutral",
  ...
  // ==========================================
  {
    id: "scifi-character-alien-diplomat",
    name: "Alien Diplomat / Ambassador",
    category: "character",
    genres: ["scifi"],
    archetype: "noble",
    gender: "neutral",
    ...
    r2Path: "silhouettes/character/scifi/alien-diplomat.svg",
  },
  {
    id: "scifi-character-frontier-marshal",
    name: "Frontier Marshal / Peacekeeper",
    category: "character",
    genres: ["scifi", "western"],
    archetype: "warrior",
    gender: "neutral",
    ...
    r2Path: "silhouettes/character/scifi/frontier-marshal.svg",
  },
  {
    id: "scifi-character-salvage-diver",
    name: "Salvage Diver / Wreck Runner",
    category: "character",
    genres: ["scifi"],
    archetype: "rogue",
    gender: "neutral",
    ...
    r2Path: "silhouettes/character/scifi/salvage-diver.svg",
  },
  {
    id: "scifi-location-desert-colony",
    name: "Desert Colony / Dome Settlement",
    category: "location",
    genres: ["scifi"],
    archetype: "structure",
    tags: [
    ...
    r2Path: "silhouettes/location/scifi/desert-colony.svg",
  },
  {
    id: "scifi-location-alien-ruins",
    name: "Alien Ruins / Portal Monoliths",
    category: "location",
    genres: ["scifi", "cosmic-horror"],
    archetype: "structure",
    tags: [
    ...
    r2Path: "silhouettes/location/scifi/alien-ruins.svg",
  },
  {
    id: "scifi-location-terraforming-facility",
    name: "Terraforming Facility / Atmosphere Plant",
    category: "location",
    genres: ["scifi"],
    archetype: "structure",
    tags: [
    ...
    r2Path: "silhouettes/location/scifi/terraforming-facility.svg",
  },
  {
    id: "scifi-faction-stellar-republic",
    name: "Stellar Republic / Galactic Union",
    category: "faction",
    genres: ["scifi"],
    archetype: "insignia",
    tags: [
    ...
    r2Path: "silhouettes/faction/scifi/stellar-republic.svg",
  },
  {
    id: "scifi-faction-mining-consortium",
    name: "Mining Consortium / Asteroid Guild",
    category: "faction",
    genres: ["scifi", "cyberpunk"],
    archetype: "insignia",
    tags: [
    ...
    r2Path: "silhouettes/faction/scifi/mining-consortium.svg",
  },
  {
    id: "scifi-faction-alien-hive",
    name: "Alien Hive / Swarm Collective",
    category: "faction",
    genres: ["scifi", "cosmic-horror"],
    archetype: "insignia",
    tags: [
    ...
    r2Path: "silhouettes/faction/scifi/alien-hive.svg",
  },
  {
    id: "scifi-event-hyperspace-arrival",
    name: "Hyperspace Arrival / Jump Transit",
    category: "event",
    genres: ["scifi"],
    archetype: "pilot",
    tags: [
    ...
    r2Path: "silhouettes/event/scifi/hyperspace-arrival.svg",
  },
  {
    id: "scifi-event-solar-storm",
    name: "Solar Storm / Stellar Flare",
    category: "event",
    genres: ["scifi"],
    archetype: "generic",
    tags: [
    ...
    r2Path: "silhouettes/event/scifi/solar-storm.svg",
  },
  {
    id: "scifi-event-first-contact",
    name: "First Contact / Alien Summit",
    category: "event",
    genres: ["scifi"],
    archetype: "noble",
    tags: [
    ...
    r2Path: "silhouettes/event/scifi/first-contact.svg",
  },
